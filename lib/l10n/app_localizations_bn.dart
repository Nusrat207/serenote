...
class AppLocalizationsBn extends AppLocalizations {
  ...
  String journal_delete_confirm(Object title) {
    return 'আপনি কি নিশ্চিত যে \"$title\" মুছতে চান?';
  }
  ...
  @override
  String get journal_search_hint => 'জার্নাল খুঁজুন...';
  ...
  @override
  String get help_center_title => 'হেল্প সেন্টার';

  @override
  String get getting_started => 'শুরু করুন';

  @override
  String get getting_started_desc => 'সেরিনোট ফিচারগুলি ব্যবহার করা শিখুন';

  @override
  String get faq => 'FAQ';

  @override
  String get faq_desc => 'প্রায়শই জিজ্ঞাসিত প্রশ্ন';

  @override
  String get contact_support => 'সাপোর্টে যোগাযোগ করুন';

  @override
  String get contact_support_desc => 'আমাদের টিমের সাথে যোগাযোগ করুন';

  @override
  String get privacy_policy => 'প্রাইভেসি পলিসি';

  @override
  String get privacy_policy_desc =>
      'আমাদের প্রাইভেসি প্র্যাকটিস সম্পর্কে জানুন';

  @override
  String get guide_step_1 => 'আপনার অ্যাকাউন্ট তৈরি করুন';

  @override
  String get guide_step_1_desc =>
      'সাইন আপ বা লগইন করে সেরিনোট ব্যবহার শুরু করুন। আপনার ডেটা সব ডিভাইসে সিঙ্ক হবে।';

  @override
  String get guide_step_2 => 'আপনার প্রোফাইল সেটআপ করুন';

  @override
  String get guide_step_2_desc =>
      'আপনার অভিজ্ঞতা ব্যক্তিগতকরণ করতে ডিসপ্লে নাম এবং অ্যাভাটার যোগ করুন।';

  @override
  String get guide_step_3 => 'ফিচারগুলি এক্সপ্লোর করুন';

  @override
  String get guide_step_3_desc =>
      'টুডু, জার্নাল, টাইমার, এবং গেমস চেষ্টা করে দেখুন কোনটি আপনার জন্য সবচেয়ে ভালো কাজ করে।';

  @override
  String get guide_step_4 => 'আপনার প্রথম টুডু তৈরি করুন';

  @override
  String get guide_step_4_desc =>
      'সংগঠিত থাকতে আপনার টুডু লিস্টে টাস্ক যোগ করে শুরু করুন।';

  @override
  String get guide_step_5 => 'আপনার প্রথম জার্নাল লিখুন';

  @override
  String get guide_step_5_desc =>
      'আপনার ব্যক্তিগত জার্নালে আপনার চিন্তাভাবনা এবং প্রতিফলন প্রকাশ করুন।';

  @override
  String get faq_question_1 => 'আমি কীভাবে আমার পাসওয়ার্ড রিসেট করব?';

  @override
  String get faq_answer_1 =>
      'লগইন স্ক্রিনে যান, \"পাসওয়ার্ড ভুলে গেছেন\" ক্লিক করুন এবং আপনার ইমেইলে পাঠানো নির্দেশাবলী অনুসরণ করুন।';

  @override
  String get faq_question_2 => 'আমার ডেটা কি সুরক্ষিত?';

  @override
  String get faq_answer_2 =>
      'হ্যাঁ, আপনার সমস্ত ডেটা এনক্রিপ্ট করা এবং নিরাপদে সংরক্ষণ করা হয়। আমরা ইন্ডাস্ট্রি-স্ট্যান্ডার্ড সিকিউরিটি প্র্যাকটিস ব্যবহার করি।';

  @override
  String get faq_question_3 => 'আমি কি সেরিনোট অফলাইনে ব্যবহার করতে পারি?';

  @override
  String get faq_answer_3 =>
      'হ্যাঁ, বেশিরভাগ ফিচার অফলাইনে কাজ করে। আপনি ইন্টারনেটে পুনঃসংযোগ করলে আপনার ডেটা সিঙ্ক হবে।';

  @override
  String get faq_question_4 => 'আমি কীভাবে আমার অ্যাকাউন্ট মুছব?';

  @override
  String get faq_answer_4 =>
      'হেল্প সেন্টার থেকে সাপোর্টে যোগাযোগ করে অ্যাকাউন্ট ডিলিশন রিকোয়েস্ট করুন।';

  @override
  String get faq_question_5 => 'কোনো সাবস্ক্রিপশন ফি আছে কি?';

  @override
  String get faq_answer_5 =>
      'সেরিনোট বর্তমানে বিনামূল্যে ব্যবহারের জন্য উপলব্ধ। ভবিষ্যতে আমরা প্রিমিয়াম ফিচার চালু করতে পারি।';

  @override
  String get contact_get_in_touch => 'যোগাযোগ করুন';

  @override
  String get contact_help_desc =>
      'আমরা যেকোনো সমস্যা বা প্রশ্নে আপনাকে সাহায্য করতে এখানে আছি।';

  @override
  String get contact_email_support => 'ইমেইল সাপোর্ট';

  @override
  String get contact_email => 'support@serenote.com';

  @override
  String get contact_live_chat => 'লাইভ চ্যাট';

  @override
  String get contact_chat_hours =>
      'সোম-শুক্র সকাল ৯টা-সন্ধ্যা ৬টা পর্যন্ত উপলব্ধ';

  @override
  String get contact_send_message => 'আমাদের একটি মেসেজ পাঠান';

  @override
  String get contact_your_email => 'আপনার ইমেইল';

  @override
  String get contact_message => 'মেসেজ';

  @override
  String get contact_send_button => 'মেসেজ পাঠান';

  @override
  String get contact_message_sent => 'সাপোর্ট টিমে মেসেজ পাঠানো হয়েছে!';

  @override
  String get privacy_info_collected => 'আমরা যে তথ্য সংগ্রহ করি';

  @override
  String get privacy_info_collected_desc =>
      'আপনি সরাসরি আমাদের যে তথ্য প্রদান করেন তা আমরা সংগ্রহ করি, যেমন যখন আপনি অ্যাকাউন্ট তৈরি করেন, আমাদের ফিচার ব্যবহার করেন, বা সাপোর্টের জন্য আমাদের সাথে যোগাযোগ করেন।';

  @override
  String get privacy_info_usage => 'আমরা আপনার তথ্য কীভাবে ব্যবহার করি';

  @override
  String get privacy_info_usage_desc =>
      'আমরা আমাদের পরিষেবাগুলি প্রদান, রক্ষণাবেক্ষণ এবং উন্নত করতে, নতুন পরিষেবা বিকাশ করতে এবং সেরিনোট ও আমাদের ব্যবহারকারীদের রক্ষা করতে সংগ্রহ করা তথ্য ব্যবহার করি।';

  @override
  String get privacy_info_sharing => 'তথ্য শেয়ারিং';

  @override
  String get privacy_info_sharing_desc =>
      'আমরা আপনার ব্যক্তিগত তথ্য কোম্পানি, সংস্থা বা সেরিনোটের বাইরের ব্যক্তিদের সাথে শেয়ার করি না, নিম্নলিখিত ক্ষেত্রগুলি ছাড়া: আপনার সম্মতিতে, আইনি কারণে, বা ডোমেইন অ্যাডমিনিস্ট্রেটরদের সাথে।';

  @override
  String get privacy_data_security => 'ডেটা সিকিউরিটি';

  @override
  String get privacy_data_security_desc =>
      'আমরা যে তথ্য ধারণ করি তার অননুমোদিত অ্যাক্সেস বা অননুমোদিত পরিবর্তন, প্রকাশ, বা ধ্বংস থেকে আমাদের ব্যবহারকারীদের রক্ষা করতে কঠোর পরিশ্রম করি।';

  @override
  String get privacy_your_rights => 'আপনার অধিকার';

  @override
  String get privacy_your_rights_desc =>
      'আপনার ব্যক্তিগত তথ্য অ্যাক্সেস, সংশোধন বা মুছে ফেলার অধিকার আপনার আছে। আপনি আমাদের আপনার ব্যক্তিগত তথ্য প্রক্রিয়াকরণের বিরুদ্ধেও আপত্তি করতে পারেন।';

  @override
  String get about_title => 'সেরিনোট সম্পর্কে';

  @override
  String get about_description =>
      'সেরিনোট একটি মাইন্ডফুল কম্প্যানিয়ন। সেরিনোট ব্যবহারকারীদের মানসিক সচেতনতা গড়ে তুলতে, তাদের মুড এবং অভ্যাস ট্র্যাক করতে এবং প্রতিফলন এবং ফোকাস-বর্ধক মিনি-গেমের মাধ্যমে শান্তি খুঁজে পেতে সহায়তা করার জন্য ডিজাইন করা হয়েছে। এটি জার্নালিং, মাইক্রো-হ্যাবিট ট্র্যাকিং, মোটিভেশনাল উদ্ধৃতি এবং সফট গ্যামিফিকেশনকে একত্রিত করে - মৃদু বৃদ্ধি, ভারসাম্য এবং অন্তর্দৃষ্টির জন্য একটি স্থান তৈরি করে।';

  @override
  String get sidebar_signup_login => 'সাইন আপ বা লগইন করুন';

  @override
  String get sidebar_guest_mode => 'আপনি বর্তমানে গেস্ট মোডে আছেন';

  @override
  String get sidebar_login_button => 'লগইন';

  @override
  String get sidebar_signup_button => 'সাইন আপ';

  @override
  String get sidebar_logout => 'লগআউট';
  ...
  @override
  String get settings_language_desc => 'অ্যাপের ভাষা পরিবর্তন করুন';

  @override
  String get settings_about => 'সম্পর্কে';

  @override
  String get settings_about_desc => 'সেরিনোট সম্পর্কে জানুন';

  @override
  String get settings_help => 'হেল্প সেন্টার';

  @override
  String get settings_help_desc => 'সাহায্য এবং সাপোর্ট পান';

  @override
  String get journal_delete_cancel => 'বাতিল';

  @override
  String get journal_delete_delete => 'মুছুন';

  @override
  String get journal_delete_error => 'ত্রুটি: জার্নালের কোনো আইডি নেই';

  @override
  String get journal_delete_success => 'জার্নাল এন্ট্রি মুছে ফেলা হয়েছে';

  @override
  String get journal_error_loading => 'জার্নাল লোড করতে ত্রুটি: ';

  @override
  String get journal_retry => 'আবার চেষ্টা করুন';

  @override
  String get journal_login_description =>
      'জার্নাল এন্ট্রি তৈরি, দেখতে বা ম্যানেজ করতে আপনাকে লগইন করতে হবে।';

  @override
  String get journal_start_journey => 'শুরু করুন';
  ...
  @override
  String get journal_no_matching => 'কোনো মিল পাওয়া যায়নি';

  @override
  String get journal_try_different => 'ভিন্ন সার্চ টার্ম চেষ্টা করুন';

  @override
  String get journal_editor_new_title => 'নতুন জার্নাল এন্ট্রি';

  @override
  String get journal_editor_edit_title => 'জার্নাল এন্ট্রি সম্পাদনা করুন';

  @override
  String get journal_editor_title_hint => 'শিরোনাম';

  @override
  String get journal_editor_content_hint => 'আপনার ভাবনা লিখুন...';

  @override
  String get journal_editor_record_audio => 'অডিও রেকর্ড করুন';

  @override
  String get journal_editor_stop_recording => 'রেকর্ডিং বন্ধ করুন';

  @override
  String get journal_editor_recording_started => 'অডিও রেকর্ডিং শুরু হয়েছে';

  @override
  String get journal_editor_recording_stopped => 'অডিও রেকর্ডিং বন্ধ হয়েছে';

  @override
  String get journal_editor_link_mood => 'মুডের সাথে লিংক করুন';

  @override
  String get journal_editor_tags => 'ট্যাগ';

  @override
  String get journal_editor_add_tag => 'ট্যাগ যোগ করুন';

  @override
  String get journal_editor_add_image => 'ছবি যোগ করুন';

  @override
  String get journal_editor_image_added => 'ছবি সফলভাবে যোগ করা হয়েছে!';

  @override
  String get journal_editor_invalid_image => 'অবৈধ ছবি ফরম্যাট';

  @override
  String get journal_editor_image_error => 'ছবি নির্বাচনে ত্রুটি: ';

  @override
  String get journal_editor_save_error => 'জার্নাল সংরক্ষণে ত্রুটি: ';

  @override
  String get journal_editor_validation_error =>
      'দয়া করে শিরোনাম এবং বিষয়বস্তু উভয়ই পূরণ করুন';

  @override
  String get journal_editor_created => 'জার্নাল এন্ট্রি তৈরি হয়েছে!';

  @override
  String get journal_editor_updated => 'জার্নাল এন্ট্রি আপডেট হয়েছে!';

  @override
  String get journal_editor_add_tag_dialog => 'ট্যাগ যোগ করুন';

  @override
  String get journal_editor_tag_hint => 'ট্যাগের নাম লিখুন';

  @override
  String get journal_editor_cancel => 'বাতিল';

  @override
  String get journal_editor_add => 'যোগ করুন';
}
